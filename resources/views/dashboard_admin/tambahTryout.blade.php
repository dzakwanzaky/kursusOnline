    ...
    <form method="POST" action="{{ route('tryout.store')}}" enctype="multipart/form-data">                 
        ...
        <div class="card-body">
					  <label style="float:left">Nama Tryout 
						  <input type="text" class="form-control-half" id="nama" name="nama" style="float:left">
            </label>

            <label style="float:right">Jumlah Soal 
              <input type="text" class="form-control-half" id="jumlah_soal" name="jumlah_soal" style="float:right">
            </label>
        </div>
