              ...
              <thead class="thead-dark">
                ...
                <tbody>
                    ...
                    <td>{{ $no++ }}</td>
                        <td>{{ $d->mapel }}</td>
                        <td class="d-flex">
                        <a type="button" class="btn btn-sm btn-primary mr-2" href="{{route('mapel.edit',$d->id)}}">Edit</a>

                          <form action="{{ route('mapel.destroy', $d->id) }}" method="post" class="destroy">
                          {{ csrf_field() }}
                          {{ method_field('DELETE') }}   
