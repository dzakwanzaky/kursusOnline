...
<!-- SCRIPT PAGE BERISI LINK DAN SCRIPT -->
    ...
    <link rel="stylesheet" href="{{asset('/view')}}/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="{{asset('/view')}}/css/magnific-popup.css">

    <link rel="stylesheet" href="{{asset('/view')}}/css/aos.css">

    <link rel="stylesheet" href="{{asset('/view')}}/css/ionicons.min.css">

    <link rel="stylesheet" href="{{asset('/view')}}/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="{{asset('/view')}}/css/jquery.timepicker.css">

    
    <link rel="stylesheet" href="{{asset('/view')}}/css/flaticon.css">
