...
<body>
    ...
    <div class="container-content">
        ...
        <form method="POST" action="{{ route('pendaftaranSiswa.store')}}" enctype="multipart/form-data">
                @csrf
                <h2 class="form-title">Pendaftaran Bimbel Program Seleksi Mandiri PTN</h2>
                ...
                <div class="panel-body">
                    ...
                    <input type="text" class="form-control" id="program" name="program" style="display:none" value="Seleksi Mandiri PTN">
