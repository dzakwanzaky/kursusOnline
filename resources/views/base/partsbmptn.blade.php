    ...
    padding-top: 20px;
				...
				<div class="container">
					...
					<br>
						...
						<div class="typing">
							<h4>
								<b><font color="#000">Program SBMPTN</b>
								<br>
								<p><br>
								Program untuk calon mahasiswa yang akan menghadapi
                Ujian Seleksi Bersama Masuk Perguruan Tinggi Negeri</p>
							</font>
							</h4>
						...
						<div class="col-lg-8 left-contents">
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            <div class="jq-tab-menu">
	                                <div class="jq-tab-title active" data-tab="1"><font face="Poppins">Soal TKPA</font></font></div>
	                                <div class="jq-tab-title" data-tab="2"><font face="Poppins">Soal TKD Saintek</font></font></div>
	                                <div class="jq-tab-title" data-tab="3"><font face="Poppins">Soal TKD Soshum</font></font></div>
