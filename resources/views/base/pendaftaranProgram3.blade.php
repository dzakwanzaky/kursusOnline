                ...
                <form method="POST" action="{{ route('pendaftaranSiswa.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="panel-body">
                        ...
                        <input id="nama_murid" style="display:none" type="text" class="form-control" name="nama_murid"
                            required autofocus value="{{ Auth::user()->name }}" style="text-transform: capitalize">
                        ...
                        <label for="mata_pelajaran" style="float:right">Jumlah
                            <select id="jumlah_matpel" name="jumlah_matpel" class="form-control" style="float:right">
                    ...
                    <label style="width:100%"> Jumlah Pertemuan
                        <select id="sesi1-select" name="sesi" class="form-control" style="width:100%">
                    ...
                    <div id="sesi2">
                    <label style="width:100%"> Jumlah Pertemuan
                        <select id="sesi2-select" name="sesi" class="form-control" style="width:100%">
                            <option value="">Pilih Sesi</option>
                            <option value="4">4</option>
                            <option value="8">8</option>
                        </select>
                    ...
                    <div id="sesi3">
                    <label style="width:100%"> Jumlah Pertemuan
                        <select id="sesi3-select" name="sesi" class="form-control" style="width:100%">
                            <option value="">Pilih Sesi</option>
                            <option value="4">4</option>
                            <option value="8">8</option>
                        </select>
                    ...
                    <div id="div1" name="div1" class="panel-body">
                        ...
                        <div id="waktu2">
                            <label for="hari1">Sesi 2
                                <select id="hari2" name="hari1" class="form-control" style="float:left">
                                    <option value="_none">Pilih Hari</option>
                                    <option value="Senin">Senin</option>
                                    <option value="Selasa">Selasa</option>
                                    <option value="Rabu">Rabu</option>
                            ...
                            <label for="waktu_hari1" style="float:right">Waktu Sesi 2
                                <select id="waktu_hari" name="waktu" class="form-control" style="float:right">
                                    <option value="_none">Pilih Waktu</option>
                                    <option value="15.00">15.00 WIB</option>
                                    <option value="16.00">16.00 WIB</option>
                                    <option value="17.00">17.00 WIB</option>
