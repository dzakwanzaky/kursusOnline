<div class="awake">
    ...
    <section class="search-course-area relative" style="background:url('frontend/img/satu.png')">
        ...
        <div class="typing">
            <h4>
                <b>
                    <font color="#000">Program SMA
                </b>
                <br>
                <p><br>
                    Program untuk siswa Sekolah Menengah Atas yang akan menghadapi ujian nasional</p>
                </font>
            </h4>
        ...
        <section class="course-details-area pt-12">
            ...
            <div class="col-lg-8 left-contents">
                ...
                <div class="jq-tab-wrapper" id="horizontalTab">
                    <div class="jq-tab-menu">
                        ...
                        <div class="jq-tab-title" data-tab="3">
                            <font face="Poppins">Fisika</font>
                            </font>
                        </div>
                        <div class="jq-tab-title" data-tab="4">
                            <font face="Poppins">Kimia</font>
                            </font>
                        </div>
                        <div class="jq-tab-title" data-tab="5">
                            <font face="Poppins">Biologi</font>
                            </font>
                        </div>
                        <div class="jq-tab-title" data-tab="6">
                            <font face="Poppins">Ekonomi</font>
                            </font>
                        </div>
                        <div class="jq-tab-title" data-tab="7">
                            <font face="Poppins">Sosiologi</font>
                            </font>
                        </div>
                        <div class="jq-tab-title" data-tab="8">
                            <font face="Poppins">Geografi</font>
                            </font>
                        </div>
                        <div class="jq-tab-title" data-tab="9">
                            <font face="Poppins">Sejarah</font>
                            </font>
                        </div>
                        <div class="jq-tab-title" data-tab="10">
                            <font face="Poppins">Bahasa Inggris</font>
                            </font>
                        </div>
                    ...
                    @php $no=1; @endphp @foreach($bind as $d) <div class="jq-tab-content active" data-tab="2">
                ...
                @php $no = 1; @endphp
                @foreach($kim as $d)
                <div class="jq-tab-content active" data-tab="4">
                ...
                @php $no = 1; @endphp
                @foreach($bio as $d)
                <div class="jq-tab-content active" data-tab="5">
                ...
                @php $no = 1; @endphp
                @foreach($eko as $d)
                <div class="jq-tab-content active" data-tab="6">
                ...
                @php $no = 1; @endphp
                @foreach($sosio as $d)
                <div class="jq-tab-content active" data-tab="7">
                ...
                @php $no = 1; @endphp
                @foreach($geo as $d)
                <div class="jq-tab-content active" data-tab="8">
                ...
                @php $no = 1; @endphp
                @foreach($sej as $d)
                <div class="jq-tab-content active" data-tab="9">
                ...
                @php $no = 1; @endphp
                @foreach($bing as $d)
                <div class="jq-tab-content active" data-tab="10">
