            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr class="photo">
                        <h4 class="font-weight-normal" style="text-align:center" ><?php echo e($u->id); ?> - <?php echo e($u->name); ?>
                        ...
                        <h6 class="font-weight-normal" style="text-align:center"><?php echo e($u->email); ?>
                            ...
                            <br>
                            <a href="<?php echo e(route('register.edit',$u->id)); ?>" class="btn-edit-info"
...
<?php echo $__env->make('murid/base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Pictures\bismilah\bismilah\resources\views/murid/profile.blade.php ENDPATH**/ ?>