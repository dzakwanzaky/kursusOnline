    ...
    <header class="top-bar">
        <nav class="navbar header-nav navbar-expand-lg">
            ...
            <a class="navbar-bran" href="/">
                <img class="navbar-brand-full" src="<?php echo e(('/tema/images/inofa.png')); ?>" width="100" height="30" alt="Logo Inofa" href="/">
            </a>
                <?php if(Auth::guest()): ?>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarApp">
                    <ul class="navbar-nav">
                        ...
                        <li>
                            <a href="/probel-dinamis" class="nav-link <?php echo e('probel-dinamis' == request()->path() ? 'nav-link active' : ''); ?>">Tryout
                            </a>
                        </li>
                        <li>
...
<?php /**PATH D:\ini TA GUE\PROJEK\PROJEK\resources\views/base/header_page.blade.php ENDPATH**/ ?>