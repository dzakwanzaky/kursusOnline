   ...
   <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-6 text-center heading-section ftco-animate">
            ...
            <p><font size="4px">Anda semakin beruntung karena semua manfaat ini hanya ada di Inofa Bimbel</p>
          </div>
        </div>
        <br>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p><font size="4px">Dengan metode tatap muka memudahkan siswa menyerap materi sehingga belajar makin efektif.</p></font>
              </div>
            </div>      
          </div>
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p><font size="4px">Fokus dengan materi yang diajarkan oleh tutor karena dengan tatap muka secara langsung.</font></p>
              </div>
            </div>      
          </div>
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              <div class="d-flex justify-content-center"><div class="icon color-2 d-flex justify-content-center mb-3"><span class="align-self-center fa fa-refresh"></span></div></div>
              <div class="media-body p-2 mt-3">
                <h2 class="heading" style="color:#4a4a4a; font-family:calibri">Fleksibel</h2>
                <p><font size="4px">Penawaran jadwal hari, waktu, dan tempat yang dapat disesuaikan dengan kebutuhan siswa dan tentor.</font></p>
              </div>
            </div>    
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p><font size="4px">Kami menawarkan cara belajar yang cocok dan sesuai untuk memaksimalkan potensi setiap siswa</p></font>
              </div>
            </div>      
          </div>
    ...
    <section class="ftco-section">
      <div class="container">
          ...
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
              <a href="portfolio.html" class="image image-2 " style="background-image: url('images/work-2.jpg');" data-scrollax=" properties: { translateY: '-20%'}"></a>
            <div class="text">
          ...
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            ...
            <div class="text order-1">
              ...
              <p>Soal latihan dan pembahasan yang kami berikan merupakan suatu bentuk pelayanan kami kepada pengguna agar pengguna semakin mengerti dan paham akan pelayanan kami. </p>
              <p><a href="/probel" class="btn btn-primary px-4">Lihat Soal</a></p>
            </div>
          </div>
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a href="portfolio.html" class="image image-2" style="background-image: url('images/work-3.jpg'); " data-scrollax=" properties: { translateY: '-20%'}"></a>
            <div class="text">
              <h4 class="subheading">Proses</h4>
              <h2 class="heading"><a href="portfolio.html">Proses pendaftaran mudah, murah dan terpercaya</a></h2>
              <p>Bimbingan belajar kami sudah dipercayai oleh banyak pengguna dikarenakan selain lengkap, bimbingan kami juga murah dalam biaya dan proses pendaftaran untuk mendapatkan layanan dari kami juga sangat mudah.</p>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <p><font size="4px">Testimoni dari pengguna yang telah menggunakan Inofa Bimbel untuk membantu meraih mimpi mereka</p></font>
          </div>
        </div>
...
<?php $__currentLoopData = $testi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="item text-center">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-5"><?php echo e($u->isi); ?></p>
                    <p class="name" style="color:#4a4a4a"><?php echo e($u->nama_lengkap); ?></p>
                    <span class="position"><?php echo e($u->program); ?></span>
                  </div>
                </div>
              </div>
   ...
   <section class="ftco-section ftco-bg-dark">
     <div class="row mt-5 d-flex justify-content-center">
          <div class="col-md-8 text-center heading-section ftco-animate">
           ...
           <div class="box">
           <a href="/login" class="btn btn-white btn-animation-1"><font color="#DB7093">Gabung sekarang</font></a>
...
<?php echo $__env->make('base/script_here', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TA\kursusOnline\resources\views/base/home_page.blade.php ENDPATH**/ ?>