                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-xs-6">
                                ...
                                <div class="small-box bg-yellow">
                                    <div class="inner">
                                        <h3><?php echo e(DB::table('model_invoice')->where('status','BELUM AKTIF')->count()); ?></h3>
                                        <p>Pendaftaran <br>
                                         Les Siswa</p>
                                    </div>
                                    <div class="icon">
...
<?php echo $__env->make('dashboard_admin/base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ini TA GUE\PROJEK\PROJEK\resources\views/dashboard_admin/admin.blade.php ENDPATH**/ ?>