    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('soalTO', $d->id_to)); ?>" method="get">
            ...
            <div id="box">
                ...
                <a href="<?php echo e(route('wizardsbm', $d->tryout->program->id)); ?>" class="ok">
...
<?php echo $__env->make('base/script_yesa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Pictures\bismilah\bismilah\resources\views/base/soal.blade.php ENDPATH**/ ?>