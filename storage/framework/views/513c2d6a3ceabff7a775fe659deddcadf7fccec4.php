                            ...
                            <table class="table table-bordered table-striped table-responsive-md" id="program">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($d->keterangan_rinci); ?></td>
                                        <td class="d-flex">
                                        <a type="button" class="btn-sm btn-info mr-2"  data-toggle="tooltip" data-placement="top" title="Lihat Mapel" href="<?php echo e(route('daftarMapel', $d->id)); ?>"><i class="far fa-eye"></i></a>
...
<?php echo $__env->make('dashboard_admin/base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Pictures\baru\baru\resources\views/dashboard_admin/manajemenProgram.blade.php ENDPATH**/ ?>