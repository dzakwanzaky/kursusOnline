                    ...
                    <div class="card-body">
                        <table class="table table-responsive-lg table-bordered small" id="jadwal">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($no++); ?></td>
                                    <?php if($d->tutor_id == null): ?>
                                    <td></td>
                                    <?php else: ?>
                                    <td><?php echo e($d->tutor->name); ?></td>
                                    <?php endif; ?>
                                    <td><?php echo e($d->invoice->kelas->kelas); ?> <?php echo e($d->invoice->program->program); ?> </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('murid/base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ini TA GUE\PROJEK\PROJEK\resources\views/murid/murid.blade.php ENDPATH**/ ?>