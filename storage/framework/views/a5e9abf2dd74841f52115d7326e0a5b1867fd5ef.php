                            ...
                            <table class="table table-bordered table-striped table-responsive-md" id="datakaryawan">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <form action="<?php echo e(route('konfirmasiTutor', $d->id)); ?>" 
                                        ...
                                        <td class="d-flex">
                                                <a id="status" name="status" class="btn btn-sm btn-info mr-2"
                                                    ...
                                                    style="color:white" href="<?php echo e(route('profileTutorAdmin', $d->id)); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard_admin/baseTutor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ini TA GUE\PROJEK\PROJEK\resources\views/dashboard_admin/daftarTutorBelumAktif.blade.php ENDPATH**/ ?>