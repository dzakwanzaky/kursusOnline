...
<div class="content-wrapper">
    ...
    <div id="content" class="content">
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input style="display:none" id="id_to" name="id_to" value="<?php echo e($id); ?>"></input>
                            <div class="text-center">
                                ...
                                <div id="unggah" style="float:right;width:50%"><label for="" class="ml-4">UNGGAH
                                    ...
                                    <a class="ml-2">
                                        ...
                                        <br> <a href="<?php echo e(('/file/template-soal.xlsx')); ?>" class="btn btn-sm btn-success" style="color:white;" ><span class="fas fa-download mr-2"></span>Unduh</a> 
                                    </a>
                                    <br>
                                    <br>
                                    <button type="button" name="add" id="add" style="width:60%"
                                ...
                                <div class="modal fade" id="importExcel" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form method="post" action="<?php echo e(route('importExcel')); ?>"
            ...
            <form method="POST" action="<?php echo e(route('soal.store')); ?>" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>
...
<script>
    $('#add').click(function () {
        var html =
            ...
            <div class="card-body"><input style="display:none" id="id_to" name="id_to" value="<?php echo e($id); ?>"></input>
...
<?php echo $__env->make('dashboard_admin/base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Pictures\baru\baru\resources\views/dashboard_admin/tambahSoal.blade.php ENDPATH**/ ?>