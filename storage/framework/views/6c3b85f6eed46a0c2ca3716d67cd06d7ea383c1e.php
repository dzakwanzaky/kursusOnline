        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <a href="<?php echo e(route('tambahSoal', $d->id)); ?>"
              ...
              <thead class="thead-dark">
                ...
                <tbody>
                    ...
                    <tr>   
                        ...
                        <td class="d-flex">
                          <form action="<?php echo e(route('soal.destroy', $d->id)); ?>" method="post" class="destroy">
                          <a type="button" class="btn btn-sm btn-primary mr-2" href="<?php echo e(route('soal.edit',$d->id)); ?>">Edit</a>
...
<?php echo $__env->make('dashboard_admin/base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Pictures\baru\baru\resources\views/dashboard_admin/daftarSoal.blade.php ENDPATH**/ ?>