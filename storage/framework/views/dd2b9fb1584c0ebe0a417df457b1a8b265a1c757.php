                            ...
                            <table class="table table-bordered table-striped table-responsive-md" id="siswa">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <?php echo e($d->kelas->kelas); ?> </td>
                                       ...
                                       <td>
                                        ...
                                        <form action="<?php echo e(route('konfirmasi', $d->id)); ?>" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard_admin/baseMurid', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ini TA GUE\PROJEK\PROJEK\resources\views/dashboard_admin/daftarSiswaBelumAktif.blade.php ENDPATH**/ ?>