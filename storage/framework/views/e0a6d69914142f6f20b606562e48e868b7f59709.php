 <!-- Navbar -->
 <link rel="stylesheet" href="<?php echo e(asset('/ya')); ?>/bootstrap/css/bootstrap.min.css">
<style type="text/css">
  .h6 {
    text-align: center;
    margin-top: 15px;
...
<script src="<?php echo e(asset('/ya')); ?>/bootstrap/js/bootstrap.min.js"></script>
  <!-- /.navbar --><?php /**PATH C:\Users\ASUS\Pictures\bismilah\bismilah\resources\views/murid/header1.blade.php ENDPATH**/ ?>