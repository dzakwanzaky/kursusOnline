    ...
    <div class="main">
        <div class="container-content">
                ...
                <form method="POST" action="<?php echo e(route('pendaftaranSiswa.store')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="panel-body">
                        ...
                        <label for="mata_pelajaran" style="float:right">Paket
                            <div class="form-group2<?php echo e($errors->has('paket_id') ? ' has-error' : ''); ?>">
                    ...
                    <input id="murid_id" style="display:none" type="text" class="form-control" name="id_murid" required
                        autofocus value="<?php echo e(Auth::user()->id); ?>" style="text-transform: capitalize">
            ...
            <div id="div1" name="div1" class="panel-body">
                ...
                <input id="murid_id" style="display:none" type="text" class="form-control" name="murid_id[]" required
                    autofocus value="<?php echo e(Auth::user()->id); ?>" style="text-transform: capitalize">
                ...
                <div>
                    <label for="mata_pelajaran" style="width:100%">Mata Pelajaran
                        <select id="mata_pelajaran" name="mapel_id[]" class="form-control" style="width:100%" required>
            ...
            <div id="div2" name="div2" class="panel-body">
                ...
                <div>
                    <label for="mata_pelajaran" style="width:100%">Mata Pelajaran
                        <select id="mata_pelajaran" name="mapel_id[]" class="form-control" style="width:100%">
                            <option value="0" disabled="true" selected="true">Mata Pelajaran</option>
                            <?php $__currentLoopData = $sd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($d->id); ?>"><?php echo e($d->mapel); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('base/script_page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ini TA GUE\PROJEK\PROJEK\resources\views/base/pendaftaranProgram1.blade.php ENDPATH**/ ?>