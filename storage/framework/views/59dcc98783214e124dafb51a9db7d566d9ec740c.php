                            ...
                            <div class="kolom1">
                                ...
                                <div class="col-md-11">
                                    ...
                                    <div class="form_login<?php echo e($errors->has('asal_sekolah') ? ' has-error' : ''); ?>">
                                        <input type="text" name="asal_sekolah" class="form-control" value="<?php echo e(old('asal_sekolah')); ?>">
                                    ...
                                    <input type="text" name="program_id" class="form-control" value="<?php echo e($program_id); ?>" style="display:none" required>
...
<?php echo $__env->make('base/script_page5', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Pictures\bismilah\bismilah\resources\views/base/aksessoal.blade.php ENDPATH**/ ?>